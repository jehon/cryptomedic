...
UPDATE `appointments`
    SET NextCenter = "Forcibly Displaced Myanmar Nationals" 
    WHERE NextCenter = "Forcibly Displaced Myanmar Nat";
...
UPDATE bills
    SET Center = "Forcibly Displaced Myanmar Nationals" 
    WHERE Center = "Forcibly Displaced Myanmar Nat";
