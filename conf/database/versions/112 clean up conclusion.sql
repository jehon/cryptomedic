ALTER TABLE `ricket_consults` CHANGE `Brace` `x_Brace` VARCHAR(24) CHARACTER
SET
...
ALTER TABLE `club_feet` CHANGE `Treatment` `x_Treatment` MEDIUMTEXT CHARACTER
SET
  utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;

ALTER TABLE `other_consults` CHANGE `Surgery66` `x_Surgery66` VARCHAR(24) CHARACTER
SET
  utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;
