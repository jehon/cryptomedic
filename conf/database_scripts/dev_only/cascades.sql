...
ALTER TABLE `nonricket_consults` DROP FOREIGN KEY `nonricket_consults_ibfk_1`; 

ALTER TABLE `nonricket_consults` 
	ADD CONSTRAINT `nonricket_consults_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `amd_chakaria`.`patients`(`id`) 
	ON DELETE CASCADE ON UPDATE CASCADE;
