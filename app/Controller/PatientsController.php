...
//		}
//		if (!array_key_exists('named', $this->request->params)) {
//			return $this->render('notfound');
//		}
//		if (!array_key_exists('en', $this->request->params['named'])) {
//			return $this->render('notfound');
//		}
//		if (array_key_exists('en', $this->request->params['named'])) {
//			$en = $this->request->params['named']['en'];
//			$ey = substr($en, 0, 4);
//			$eo = trim(substr($en, 4), '-');
//			$id = $this->{$this->modelClass}->find('first',
//					array('conditions' => array('entryyear' => $ey, 'entryorder' => $eo)),
//					array('id'),
//					'id',
//					false
//					);
...
//	}
	...
	function reference($id = null) {
        ...
        if (empty($this->request->data)
            || !array_key_exists('reference-entryyear', $this->request->data)
            || $this->request->data['reference-entryyear'] == ""
            || !array_key_exists('reference-entryorder', $this->request->data)
            ) {
