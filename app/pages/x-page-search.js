...
import XRequestor, { patientSearchBuilder } from '../widgets/func/x-requestor.js';
                    ...
                    this._result = createElementWithObject(XTable, { id: 'search_results', full: true }, [],
                        (/** @type {XTable} */ el) =>
                            el
                                ...
                                .addDetail(() => createElementWithTag('img', { src: '/static/img/go.gif' }), { headers: [''] })
                                .addDetail(data => data.entryyear + '-' + data.entryorder, { headers: ['Reference'] })
