...
<fieldset>
	...
	<table  class='colorize'>
		...
		<?php (new t("NonricketConsult.Date"))->label()->p(); ?>
		<?php (new t("NonricketConsult.ExaminerName"))->label()->p(); ?>
		<?php (new t("NonricketConsult.Center"))->label()->p(); ?>
		<tr modes='read'>
...
<fieldset>
	...
	<table class='colorize'>
		...
		<tr><td/><td/><td>Deviation :</td></tr>					<tr>
			...
			<td><?php (new t("NonricketConsultWeightHeightRatio"))->label()->p(); ?></td>
		...
		</tr>		<?php (new t("NonricketConsult.Brachialcircumferencecm"))->label()->p(); ?>
