...
-- SELECT count(*), Center FROM `bills` group by Center
...
-- SELECT count(*), Center, NextCenter FROM `club_foots` group by Center, NextCenter
...
-- SELECT count(*), Center, NextCenter FROM `nonricket_consults` group by Center, NextCenter
...
-- SELECT count(*), Center, NextCenter FROM `ricket_consults` group by Center, NextCenter
