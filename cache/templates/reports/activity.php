<?php ?><div myready>
  <table class='reporting'>
    <thead>
      <tr>
          <th colspan="24" class='b_all'>SARPV - AMD - KDM</th>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <th colspan="5" class='b_bottom'></th>
      </tr>
      <tr>
    ...
    <tbody  class='b_all'>
      <tr ng-repeat='l in result.list'>
        <td class='b_left'>
          {{$index + 1}}
          <a class='online' href='#/folder/{{l.pid}}/file/Bill/{{l.bid}}'>View</a>
        </td>
        <td>{{l.Date}}</td>
        ...
        <td>{{cryptomedic.calculateAgeFromBirth(l.yearofbirth)}}</td>
        <td>{{l.Sex}}</td>
        <td>
