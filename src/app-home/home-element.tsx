  ...
  return (
    <div id="home" className="reduce-width">
      ...
      <div className="grid">
        ...
        >
          Create a patient with an <b>autogenerated</b> reference.
          Auto-generated references start at 10.000. Reference year will be
          asked on next page.
        </MenuItem>
        <MenuItem
          title="Search"
        ...
        >
          ...
          <br />
          Options: the day, the examiner, the center and type of activity.
        </MenuItem>
        <MenuItem
