...
import { ServerRequestError, TransportRequestError } from "../../legacy/app-old/v2/widgets/func/x-requestor";

async function request({ url, method, data, allowed }: { url: string; method?: string; data?: any, allowed?: number[] }) {
    url = url || "/";
    method = method || "GET";
    data = nullify(data);
    ...
    return fetch(url + (method == "GET" ? "?" + new URLSearchParams(data).toString() : ""), {
        method,
