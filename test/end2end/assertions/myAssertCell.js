...
exports.assertion = function(selector, row, column, expectedText, msg) {
    var MSG = util.format('Testing if table <%s>[r:<%s>xc:<%s>] contains text: "%s".', selector, row, column, expectedText);
  /**
  ...
  this.command = function(callback) {
      return this.api.getText(selector + " tr:nth-child(" + row + ") td:nth-child(" + column + ")", callback);
  };
