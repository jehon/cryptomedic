...
import date2CanonicString from '../../app/functions/date2CanonicString.js';
...
describe('date2CanonicString-test', function () {
	...
	it('should send back dates only', function () {
		...
		expect(date2CanonicString(new Date(2010, 10, 15, 1, 2, 3), true)).toBe('2010-11-15');
	});
	...
	it('should send back dates with time', function () {
		...
		expect(date2CanonicString(new Date(2010, 10, 15, 1, 2, 3))).toBe('2010-11-15 01:02:03 GMT+0100');
	});
