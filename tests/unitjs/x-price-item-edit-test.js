...
describe(fn(import.meta.url), function () {
    it('should initalize with value=-1', () => {
        ...
        expect(el.shadowRoot.querySelector('input[type=radio][choice="unused"]').checked).toBeTrue();
        expect(el.shadowRoot.querySelector('input[type=radio][choice="specified"]').checked).toBeFalse();
    ...
    it('should initalize with value=1', () => {
        ...
        expect(el.shadowRoot.querySelectorAll('input[type=radio]').length).toBe(3);
        expect(el.shadowRoot.querySelector('input[type=radio][choice="specified"]').checked).toBeFalse();
        expect(el.shadowRoot.querySelector('input[type=radio][choice="unused"]').checked).toBeFalse();
        expect(el.shadowRoot.querySelector('input[type=radio][choice="open"]').checked).toBeTrue();
        expect(el.shadowRoot.querySelector('input[type=number]').style.display).toBe('none');
    ...
    it('should initalize with value 200', () => {
        ...
        expect(el.shadowRoot.querySelectorAll('input[type=radio]').length).toBe(3);
        expect(el.shadowRoot.querySelector('input[type=radio][choice="specified"]').checked).toBeTrue();
        expect(el.shadowRoot.querySelector('input[type=radio][choice="unused"]').checked).toBeFalse();
        expect(el.shadowRoot.querySelector('input[type=radio][choice="open"]').checked).toBeFalse();
        expect(el.shadowRoot.querySelector('input[type=number]').style.display).not.toBe('none');
