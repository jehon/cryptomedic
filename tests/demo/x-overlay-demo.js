...
import {
  ...
  overlayAcknowledge,
  overlayWaiting
} from "../../app/js/overlay-builder.js";
...
document
  .querySelector("x-button#info")
  .addEventListener("click", () =>
    overlayAcknowledge("This is the overlay").then((data) =>
      console.info("Done with data: ", data)
    )
  );
...
document.querySelector("x-button#form").addEventListener("click", () =>
  createOverlay()
    ...
    .withForm([createElementWithTag("input", { name: "my-input" })])
