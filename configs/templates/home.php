	...
	<div class='row'>
		<div class='col-sm-offset-3 col-sm-6'>
			...
			<fieldset id='add'>
				...
				<br>
				<div ng-if="(entryyear > 0) && ((entryorder > 0) || (generate == true)) && (!generate)" class="text-center">
					<button ng-click="checkReference()" class="btn btn-primary" >Check it</button>
				</div>
				<div ng-if="(entryyear > 0) && (generate)" class="text-center">
					<button ng-click="generateReference()" class="btn btn-primary" >Generate</button>
				</div>
			</fieldset>
