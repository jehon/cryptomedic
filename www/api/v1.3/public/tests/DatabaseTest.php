...
EOSQL);
    ...
    DatabaseStructure::cacheGenerateAll();
}
...
class DatabaseTest extends TestCase {
    ...
    public function testStructureFunctions() {
        createTestTable();
        try {
            $res = DatabaseStructure::checkTableExistsAndGetDefinition('anything');
        ...
        try {
            $res = DatabaseStructure::checkFieldExistsInTableAndGetDefinition('anything', 'id');
            $this->assertTrue(false, 'Should have thrown an DatabaseUndefinedException exception');
        } catch (DatabaseInvalidStructureException $e) {
            $this->assertTrue(true, 'Exception received');
        }
        ...
        try {
            $res = DatabaseStructure::checkFieldExistsInTableAndGetDefinition('test', 'anything');
            $this->assertTrue(false, 'Should have thrown an DatabaseUndefinedException exception');
        } catch (DatabaseInvalidStructureException $e) {
            $this->assertTrue(true, 'Exception received');
        }
