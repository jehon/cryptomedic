...
<x-two-columns>
	<div>
		...
		<x-group-panel title='Conclusion'>
			<?php (new t("OtherConsult.performed"))
       ->tr2("Activities Performed by the Patient")
       ->p(); ?>
			<?php (new t("OtherConsult.not_performed"))
       ->tr2("Activities NOT Performed by the Patient")
       ->p(); ?>
		</x-group-panel>
	</div>
	<div>
