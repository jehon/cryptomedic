...
<x-group-panel title='Nutritional Data'>
	<x-fff-field>
		<div></div>
		<div slot='third' class='notModeWrite'>Standard deviation (statistic)</div>
	</x-fff-field>
	<x-fff-field field='Weightkg'>
		<div><?php (new t("Weightkg"))->value()->p(); ?></div>
		<x-fff-weight-sd slot='third' class='notModeWrite'></x-fff-weight-sd>
	</x-fff-field>

	<x-fff-field field='Heightcm'>
		<div><?php (new t("Heightcm"))->value()->p(); ?></div>
		<x-fff-height-sd slot='third' class='notModeWrite'></x-fff-height-sd>
	</x-fff-field>
	...
	<x-fff-field class='notModeWrite' field='Heightcm' label='Weight/Height Ratio'>
		<x-fff-wh></x-fff-wh>
		<x-fff-wh-sd slot='third'></x-fff-wh-sd></td>
	</x-fff-field>
	<x-fff-field label='BMI' field='Heightcm' class='notModeWrite'>
		<x-fff-bmi></x-fff-bmi>
		<x-fff-bmi-sd slot='third'></x-fff-bmi-sd>
	</x-fff-field>
</x-group-panel>
