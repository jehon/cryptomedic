...
ALTER TABLE `bills`
ADD `workshop_thoracic_brace_and_scoliosis_brace` INT(11) NOT NULL DEFAULT '0' AFTER `workshop_thoracic_brace`,
...
ALTER TABLE `prices`
ADD `workshop_thoracic_brace_and_scoliosis_brace` INT(11) NOT NULL DEFAULT '-1' AFTER `workshop_thoracic_brace`,
