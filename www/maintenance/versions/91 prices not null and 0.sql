-- Fix SocialLevel 0
ALTER TABLE `prices`
CHANGE `socialLevelPercentage_0` `socialLevelPercentage_0` FLOAT NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `consult_CDC_consultation_physio` `consult_CDC_consultation_physio` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `consult_CDC_consultation_Bengali_Doctor` `consult_CDC_consultation_Bengali_Doctor` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `consult_CDC_consultation_Doctor` `consult_CDC_consultation_Doctor` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `consult_field_visit` `consult_field_visit` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `consult_home_visit` `consult_home_visit` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `medecine_medecine` `medecine_medecine` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `medecine_calcium_30x500mg` `medecine_calcium_30x500mg` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BHKAFO_night` `workshop_BHKAFO_night` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BHKAFO_walking` `workshop_BHKAFO_walking` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_UHKAFO_night` `workshop_UHKAFO_night` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_UHKAFO_walking` `workshop_UHKAFO_walking` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BKAFO_night_-_plastic` `workshop_BKAFO_night_-_plastic` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BKAFO_walking` `workshop_BKAFO_walking` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_KAFO_night` `workshop_KAFO_night` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_UKAFO_walking` `workshop_UKAFO_walking` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_Knee_brace` `workshop_Knee_brace` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BAFO_night` `workshop_BAFO_night` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BAFO_walking` `workshop_BAFO_walking` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_AFO_night` `workshop_AFO_night` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_AFO_walking` `workshop_AFO_walking` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `workshop_DB_splint` `workshop_DB_splint` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `workshop_CP_chair_-_wooden` `workshop_CP_chair_-_wooden` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_CP_standing_table_-_wooden` `workshop_CP_standing_table_-_wooden` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `surgical_osteotomy` `surgical_osteotomy` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_epiphysiodesis` `surgical_epiphysiodesis` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_polio_AL` `surgical_polio_AL` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_percutaneous_AL_club_foot` `surgical_percutaneous_AL_club_foot` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_PMR_club_foot` `surgical_PMR_club_foot` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `surgical_other_operation` `surgical_other_operation` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `consult_give_appointment` `consult_give_appointment` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `medecine_vitamineD` `medecine_vitamineD` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_BHKAFO_Drop_lock_single_axis` `workshop_BHKAFO_Drop_lock_single_axis` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_crutch_alumenium_-_a_pair` `workshop_crutch_alumenium_-_a_pair` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_wheel_chair_china` `workshop_wheel_chair_china` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_mailwalke_brace` `workshop_mailwalke_brace` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_leg_truction` `workshop_leg_truction` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_thoracic_brace` `workshop_thoracic_brace` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_samainto_brace` `workshop_samainto_brace` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_fracture_brace_-_one_leg` `workshop_fracture_brace_-_one_leg` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_smo` `workshop_smo` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_lifspring_afo` `workshop_lifspring_afo` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_osteotomy_bi` `surgical_osteotomy_bi` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_epiphysiodesis_bi` `surgical_epiphysiodesis_bi` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `surgical_percutaneous_achil_tenotomy_bi_cmosh` `surgical_percutaneous_achil_tenotomy_bi_cmosh` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_percutaneous_achil_tenotomy_uni_cdc` `surgical_percutaneous_achil_tenotomy_uni_cdc` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_percutaneous_achil_tenotomy_bi_cdc` `surgical_percutaneous_achil_tenotomy_bi_cdc` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_PMR_club_club_foot_bi` `surgical_PMR_club_club_foot_bi` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `surgical_burn_little_release` `surgical_burn_little_release` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_physiotherapy_adult` `other_physiotherapy_adult` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_physiotherapy_child` `other_physiotherapy_child` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_group_physiotherapy` `other_group_physiotherapy` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_nutritionalSupport` `other_nutritionalSupport` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_nutritionalAdvice` `other_nutritionalAdvice` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_CMOSH_follow_up` `other_CMOSH_follow_up` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_microbus` `other_microbus` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_Other_consultation_care` `other_Other_consultation_care` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_physiotherapy` `other_physiotherapy` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_X_Ray` `other_X_Ray` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_making_dressing` `other_making_dressing` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_make_short_plaster` `other_make_short_plaster` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_make_long_plaster` `other_make_long_plaster` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `other_making_plaster` `other_making_plaster` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `consult_ClubFoot_Follow_up` `consult_ClubFoot_Follow_up` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_UHKAFO_-_Drop_lock_single_axis_-_MI` `workshop_UHKAFO_-_Drop_lock_single_axis_-_MI` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `workshop_Artificial_limb_-_BK_-_Endoskeleton_with_pylon_Std` `workshop_Artificial_limb_-_BK_-_Endoskeleton_with_pylon_Std` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `workshop_artificial_limb_-_AK_-_polycentric_knee_joint` `workshop_artificial_limb_-_AK_-_polycentric_knee_joint` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `prices`
CHANGE `workshop_AFO_-_Articulated` `workshop_AFO_-_Articulated` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_Extension_brace_-_AFO` `workshop_Extension_brace_-_AFO` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `prices`
CHANGE `workshop_other` `workshop_other` INT(11) NOT NULL DEFAULT '0';
