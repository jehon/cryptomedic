...
UPDATE bills
SET
  workshop_Compensation_sole_1cm = 0
WHERE
  workshop_Compensation_sole_1cm = -1;

UPDATE bills
SET
  workshop_Compensation_sole_2cm = 0
WHERE
  workshop_Compensation_sole_2cm = -1;

UPDATE bills
SET
  workshop_Compensation_sole_3cm = 0
WHERE
  workshop_Compensation_sole_3cm = -1;

UPDATE bills
SET
  workshop_Compensation_sole_4cm = 0
WHERE
  workshop_Compensation_sole_4cm = -1;

UPDATE bills
SET
  workshop_Compensation_sole_5cm = 0
WHERE
  workshop_Compensation_sole_5cm = -1;
